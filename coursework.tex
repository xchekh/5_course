...
\textbf{Основная теорема (неформально).}
Если $n \ge \tilde{O}((d_x+d_y)/\varepsilon + 1/\varepsilon^2)$, то с вероятностью не менее $3/4$ любой Saddle-ERM $(\hat{x},\hat{y})$ удовлетворяет $\Gap_F(\hat{x},\hat{y}) \le C\varepsilon$ для абсолютной константы $C$.
